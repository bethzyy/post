...
def call_glm_api(prompt):
    ...
    try:
        ...
        print("  [调用] GLM-4.6 API生成分析(启用联网搜索)...")
        ...
        search_method = "GLM-4.6 API联网搜索 + 预定义真实技术来源"
...
def generate_search_prompt():
    """生成搜索提示词"""
    today = "2026年1月31日"  # 可以改为动态获取当前日期
    return """请分析2026年AI领域的五大热点趋势。

**已知的重要AI热点(请优先考虑这些):**

1. **OpenClaw/MoltBot/ClawdBot (AI Agent助手)**
   - GitHub Star数: 106,000+ (2026年1月30日数据)
   - 特点: 个人AI助手,集成WhatsApp/Telegram/Discord等平台
   - 影响: 引发Mac mini抢购热潮,Andrej Karpathy推荐
   - 来源: https://github.com/openclaw/openclaw
   - 详情: 24小时AI助手,自托管,隐私优先

2. **多模态AI模型**
   - GPT-4V、Gemini 2.0等模型成熟
   - 实现视觉与语言深度融合
...
**要求:**
- 从以上热点中选择5个最重要的
- 每个热点提供:标题、简介、GitHub数据、技术价值、选择理由
- 必须包含真实链接和数据
- 格式统一,字数1200-1500字
...
<body>
    <div class="container">
        <h1>2026年AI五大热点</h1>
        <p class="subtitle">统一格式版 | 标题加粗 + 格式一致 + 紧凑排版</p>
...
"""
    ...
    output_file = Path('2026年AI五大热点_统一格式版.html')
